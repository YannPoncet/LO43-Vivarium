...
public class BlockDirtSurface extends BlockDirt{
	...
	{
		super.update();
		if(world.getBlock((int)(this.x/16), (int)((this.y/16)+1)) != null && world.getBlock((int)(this.x/16), (int)((this.y/16)+1)).blockType != BlockType.LIQUID && world.getBlock((int)(this.x/16), (int)((this.y/16)+1)).blockType != BlockType.GRASS)
		{
			dead = true;
